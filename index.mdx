...
<CardGroup cols={3}>
  ...
  <Card title="Three Usage Patterns" icon="layer-group">
    JavaScript API, declarative links with `data-swappit-handle`, or the `<swappit-instance>` custom element.
  </Card>
  <Card title="Smart Preloading" icon="bolt">
    Prefetch on hover or instantly — globally or per link — for instant-feel navigation.
  </Card>
  <Card title="History Support" icon="clock-rotate-left">
    Full browser back/forward button support via the History API.
  </Card>
  <Card title="Content Cache" icon="database">
    Built-in cache with per-request invalidation control.
  </Card>
  <Card title="Event System" icon="bell">
    `before`, `after`, and `error` events on every update cycle.
  </Card>
</CardGroup>
