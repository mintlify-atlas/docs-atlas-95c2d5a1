---
title: "Using the Swappit JavaScript API to Control Updates"
sidebarTitle: "JavaScript API"
description: "Use Swappit's programmatic API to call update(), preloadContents(), reinit(), and destroy() from JavaScript in response to any event."
---
...
<Steps>
  ...
  <Step title="Emits the destroy event">
