---
title: "Preloading Content with Swappit"
...
<CardGroup cols={3}>
  ...
  <Card title="hover" icon="hand-pointer">
    Content is fetched when the mouse enters the link (desktop) or when a `touchstart` fires (mobile). Ideal for secondary pages.
  </Card>
