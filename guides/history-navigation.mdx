---
title: "Browser History Navigation in Swappit"
sidebarTitle: "History Navigation"
description: "Enable back and forward browser button support in Swappit by configuring updateUrl and enableHistory together."
---
...
Only one Swappit instance can control the browser history at a time. Attempting to create a second instance with both `updateUrl: true` and `enableHistory: true` will throw an error:
