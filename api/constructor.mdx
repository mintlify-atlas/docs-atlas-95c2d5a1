---
title: "Swappit Constructor and Instance Properties"
...
| `"Swappit: El handle \"[handle]\" ya está en uso..."` | A Swappit instance with that handle is already registered in `Swappit.instances`. |
